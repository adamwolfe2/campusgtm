...
-- Initial migration with safe re-run handling
...
DROP POLICY IF EXISTS "Users can view modules in own workspaces" ON public.strategy_modules;
DROP POLICY IF EXISTS "Users can create modules in own workspaces" ON public.strategy_modules;
DROP POLICY IF EXISTS "Users can update modules in own workspaces" ON public.strategy_modules;
DROP POLICY IF EXISTS "Users can delete modules in own workspaces" ON public.strategy_modules;
DROP POLICY IF EXISTS "Users can view blocks in own modules" ON public.blocks;
DROP POLICY IF EXISTS "Users can create blocks in own modules" ON public.blocks;
DROP POLICY IF EXISTS "Users can update blocks in own modules" ON public.blocks;
DROP POLICY IF EXISTS "Users can delete blocks in own modules" ON public.blocks;
DROP POLICY IF EXISTS "Users can view onboarding data for own workspaces" ON public.onboarding_data;
DROP POLICY IF EXISTS "Users can create onboarding data for own workspaces" ON public.onboarding_data;
DROP POLICY IF EXISTS "Users can view strategies for own workspaces" ON public.generated_strategies;
DROP POLICY IF EXISTS "Users can create strategies for own workspaces" ON public.generated_strategies;
...
DROP TRIGGER IF EXISTS update_strategy_modules_updated_at ON public.strategy_modules;
...
DROP TRIGGER IF EXISTS update_generated_strategies_updated_at ON public.generated_strategies;
